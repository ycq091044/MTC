...
def GD(iteration, X, O1, O2, mask, R):
    ...
    for i in range(iteration):
        ...
        GRAD1 = grad_tmp1(Lambda)
        GRAD2 = grad_tmp2(Lambda)
        GRAD3 = grad_A1(Lambda)
        GRAD4 = grad_A2(Lambda)
        GRAD5 = grad_A3(Lambda)
...
if __name__ == '__main__':
    ...
    for j in range(3):
        ...
        # pickle.dump([A1, A2, A3, tmp1, tmp2, loss, rec], open('result_google/CMTF_{}_{}.pkl'.format(args.partial, j), 'wb'))
