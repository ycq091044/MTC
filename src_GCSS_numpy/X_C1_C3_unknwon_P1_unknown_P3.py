...
def myalgo(mask, T, O1, O2, R, iteration):
    ...
    if (max(d1, d2, d3, new_d1, new_d3) < 2 * R) and (args.multi == 1) or args.multi == 0:
...
if __name__ == '__main__':
    ...
    for i in range(3):
        ...
        A1, A2, A3, _, _, loss, rec = myalgo(mask, T, O1, O2, R=20, iteration=200)
        # pickle.dump([A1, A2, A3, loss, rec], open('result_google/google_{}_jacobi_{}_multi_{}.pkl'.format(args.jacobi,args.multi,i), 'wb'))
